...
- [redaccion.md](./redaccion.md) *(in Spanish)* — the newsroom as its people use
  ...
  two-column editor, attaching a YouTube video to it, publishing, marking the lead and pulling a story off the
...
- [deployment.md](./deployment.md) — how it ships: the three-stage Dockerfile
  ...
  (`001_content`, `002_newsletter`, `003_auth`, `004_story_video`,
  `005_mcp_tokens`, `006_google_identity`), the `runtime`
